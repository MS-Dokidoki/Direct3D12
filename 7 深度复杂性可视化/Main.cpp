...
void D3DFrame::BuildRenderItems()
{
    ...
    RenderItems[DepthComplexityTested].push_back(item);
...
void D3DFrame::BuildPipelineState()
{
    ...
    Shaders["Normal_Vs"] = CompileShader(L"shader.hlsl", NULL, "VsMain", "vs_5_0");
    Shaders["Normal_Ps"] = CompileShader(L"shader.hlsl", NormalDefine, "PsMain", "ps_5_0");
    Shaders["AlphaTested_Ps"] = CompileShader(L"shader.hlsl", AlphaTestedDefine, "PsMain", "ps_5_0");
    Shaders["DCXView_Ps"] = CompileShader(L"shader.hlsl", NULL, "PsMain_DCX", "ps_5_0");
