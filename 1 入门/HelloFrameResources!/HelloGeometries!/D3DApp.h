...
protected:
    ...
    static const int sc_cSwapChainBuffer = Def_SwapChainBufferCount;
    int iCurrBackBuffer;
    Microsoft::WRL::ComPtr<ID3D12Resource> ppSwapChainBuffer[sc_cSwapChainBuffer];
    ...
    static const int sc_cFrameResource = Def_FrameResouceCount;
    bool bUseFrameResource;
    D3DHelper::Render::FrameResource pFrameResources[sc_cFrameResource];
