...
protected:
    ...
    void DrawItems();
private:
    ComPtr<ID3D12PipelineState> pPipelineState, pPipelineState_WireFrame;    // 渲染管线
    ...
    std::unordered_map<std::string, Render::Texture> Textures;  // 纹理数据
    std::unordered_map<std::string, Light::Material> Materials; // 材质数据
    Render::MeshGeometry Geo;   // 几何体数据
